...
plt.tight_layout()
plt.savefig('./external_test_result/error_frequency/error_frequency_all_data_filtered.eps',dpi=600,bbox_inches='tight',pad_inches=1.25,orientation ='landscape')
plt.show()
plt.close() 
