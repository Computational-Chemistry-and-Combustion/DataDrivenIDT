...
#Inputs
Path = '/home/pragnesh/Git/Deploy_DDS/GMM/ManyIteration2/analysis'
Flag_value = '-t'
...
bic_list = []
score_list = []
for clusterNumber in range(2,till+1):
...
# plt.plot(aic_list,'r-',label='AIC criteria')
# plt.title('GMM - AIC criteria')
# plt.legend()
# plt.savefig('AIC.jpg')
# plt.show()

# plt.plot(bic_list,'g-',label='BIC criteria')
# plt.title('GMM - BIC criteria')
# plt.legend()
# plt.savefig('BIC.jpg')
# plt.show()

# plt.plot(score_list,'b-',label='log-likelihood criteria')
# plt.title('GMM - log-likelihood criteria')
# plt.legend()
# plt.savefig('log_likelihood.jpg')
# plt.show()
