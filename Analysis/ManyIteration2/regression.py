...
def comparison(y_act,y_pred,curr_directory,cluster_label,file_name,child_label='root',process_type ='tree_cluster'):
        #comparison of data 
        SF.check_directory(str(curr_directory)+'/result/'+str(process_type)+'/ID_comparison/ID_comparison_'+str(cluster_label)+'/')
        #checking directory 
        ...
        ID_comparison.to_csv(str(curr_directory)+'/result/'+str(process_type)+'/ID_comparison/ID_comparison_'+str(cluster_label)+'/ID_comparison_'+str(file_name)+str(cluster_label)+'.csv')
