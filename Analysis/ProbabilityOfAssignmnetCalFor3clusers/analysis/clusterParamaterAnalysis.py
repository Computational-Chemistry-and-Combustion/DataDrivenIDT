...
for i in fileName:
    ...
    for j in properties:
        ...
        try:
            ...
            pass
        plt.savefig('./IMGresult/param/'+str(folder)+'/'+str(i)+'/'+j+'.jpg')
        plt.close()
...
for i in fileName2:
    ...
    for j in final_prop:
        ...
        try:
            ...
            pass
        plt.savefig('./IMGresult/param/'+str(folder)+'/'+str(i)+'/'+final_propName[count]+'.jpg')
        plt.close()
        count = count + 1
...
for i in properties:
    ...
    try:
        ...
        pass
    plt.savefig('./IMGresult/ParaCombined/hist/'+str(folder)+'/'+str(i)+'.jpg')
    plt.close()
...
for i in properties:
    ...
    try:
        ...
        pass
    plt.savefig('./IMGresult/ParaCombined/hist_pdf/'+str(folder)+'/'+str(i)+'.jpg')
    plt.close()
