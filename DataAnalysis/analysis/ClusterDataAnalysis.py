...
plt.tight_layout()
try:
    plt.savefig('./IMGresult/fuelDataCount/'+folder+'/dataFuel.eps',dpi=600,orientation ='landscape')
...
plt.tight_layout()
try:
    plt.savefig('./IMGresult/fuelDataCount/'+folder+'/dataFuel_fraction.eps',dpi=600,orientation ='landscape')
except FileNotFoundError:
    os.mkdir('./IMGresult/fuelDataCount/'+folder+'/')
    plt.savefig('./IMGresult/fuelDataCount/'+folder+'/dataFuel_fraction.eps',dpi=600,orientation ='landscape')
plt.show()
